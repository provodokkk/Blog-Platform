...
export class LoginModel {
    ...
    checkUser(emailValue, passwordValue) {
        ...
        let usersVerification = JSON.parse(localStorage.getItem('usersVerification'));
        ...
        usersVerification.every((user) => {
            emailValid      += this.checkData(emailValue, user.emailValue);  // when the email is found in the database, the letiable will increase
